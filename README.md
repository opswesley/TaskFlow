...
7. **Task Filters**
   - View all tasks, only pending tasks, or only completed tasks.
...
### Web View
![Web View](https://i.postimg.cc/WzMQvgf9/image.png)
...
7. **Filtros de Tarefas**
   - Visualize todas as tarefas, apenas as pendentes ou apenas as concluídas.
...
### Visualização Web
![Visualização Web](https://i.postimg.cc/WzMQvgf9/image.png)
